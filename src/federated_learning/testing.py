...
#def apply_ratio(tensors, ratio):
#  return tf.multiply(tf.add_n(tensors), ratio)
  '''
  for i in range(len(tensors)):
    todelete = tensors[i]
    tensors[i] = tf.math.multiply(tensors[i], ratio[i])
...
tensor2 = tf.constant([[8.0, 5.0], [4.0, 1.0]])
tensor3 = tf.constant([[8.0, 5.0], [4.0, 0.0]])
#print(tensor1)
#print(tensor2)
print(agg_ignoring_zeros([tensor1, tensor2, tensor3], [1.0/3.0, 1.0/3.0, 1.0/3.0]))
print(agg_skipping_zeros([tensor1, tensor2, tensor3], [1.0/3.0, 1.0/3.0, 1.0/3.0]))
print(agg_force_zeros([tensor1, tensor2, tensor3], [1.0/3.0, 1.0/3.0, 1.0/3.0]))
